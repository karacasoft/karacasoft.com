...
<html>
  <head>
    ...
    <link rel="stylesheet" href="css/karacasoft.min.css">
  </head>
  <body>
    <div id="app-container" class="background">
      <div id="big-text">
        <span class="small-text">I develop</span><br />
        <p class="big-text-frontface">
          <span class="switching-text"></span>
          <span class="non-switching-text">Software</span>
        </p>
      </div>
      <div id="profile">
        <img class="img img-round" src="img/profilepic.jpg" width="200" height="200" alt="The Magnificent Profile Picture of Mahmut Karaca" /><br />
        <p class="name">Mahmut Karaca</p>
        <p class="description">I write code... with style</p>
        <div class="links">
          <a class="facebook-link" href="https://www.facebook.com/triforce333">
          ...
          <a class="twitter-link" href="https://twitter.com/triforce930">
          ...
          <a class="github-link" href="https://github.com/triforce930">
          ...
          <a class="e-mail-link" href="mailto:mahmut.karaca@karacasoft.com">
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"><path d="M12 .02c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm6.99 6.98l-6.99 5.666-6.991-5.666h13.981zm.01 10h-14v-8.505l7 5.673 7-5.672v8.504z"/></svg>
          </a>
        </div>
      </div>
      <div id="content">
        <div class="section">
          ...
          <p>I write code...</p>
          <h1>How I do it?</h1>
          <p>With <span class="style">style</span>!!</p>
        </div>
        ...
        <div class="section">
          ...
          <button 
            ...
            Might Be Able To See In This Page</button>
          <ul class="areas-expert down-arrow">
            ...
            <li>
              ...
              <p class="description">My first love! I've started my
            ...
            <li>
              ...
              <p class="description">Every programmer should have basic
            ...
            <li>
              ...
              <p class="description">I remember wondering how websites
            ...
            <li>
              ...
              <span class="area-experience">Experience: A lot more than
                Android</span>
              <p class="description">I've learned Java by learning
          ...
          <p>Here's a list of also what I have experience with, but contents of this list
            ...
            <ul class="areas-not-expert down-arrow">
              <li><span class="area-name">C/C++</span><span class="area-experience">Experience: 1-2 years</span>
                <p class="description">I've not written applications in C/C++. But used it in some everyday(!) cases
              ...
              <li><span class="area-name">OS Development</span><span class="area-experience">Experience: A few months (in total)</span>
                <p class="description">This is my latest trend I think. One day, I decided to build my own operating
              ...
              <li><span class="area-name">Arduino/Microcontrollers</span><span class="area-experience">Experience: A few months (in total)</span>
                <p class="description">Arduino was a fascinating thing for me at first. The maker inside me was awakened,
              ...
              <li><span class="area-name">Game Engines</span><span class="area-experience">Experience: A few weeks (in total)</span>
                <p class="description">(This should not be written here. I've very few works with these tools.) I've
              ...
              <li><span class="area-name">iOS</span><span class="area-experience">Experience: Not more than one day</span>
                <p class="description">(This should not be here.). Thought I should learn it someday. Never learned,
        ...
        <div class="section">
          <h1>What have you done, so far?</h1>
          ...
          <ul class="projects down-arrow">
            <li><span class="project-name">Caps Yapıcı / Meme Generator</span><span class="project-status">Status: Sold</span>
              <p class="description">Caps Yapıcı was the leading application to generate memes that were becoming
            ...
            <li><span class="project-name">Asteroid Rush</span><span class="project-status">Status: Discontinued</span>
              <p class="description">Asteroid Rush was the very first game I've developed for Android. It had a very
            ...
            <li><span class="project-name">Video Player for Cardboard</span><span class="project-status">Status: Discontinued, on Google Play Store</span>
              <p class="description">This was my first attempt to create a Cardboard application. When the Cardboard
            ...
            <li><span class="project-name">ColorPickerView for Android</span><span class="project-status">Status: On GitHub, not maintained for years</span>
              <p class="description">I needed a color picker view for my Caps Yapıcı application. Instead of searching
            ...
            <li><span class="project-name">Tetris(160)</span><span class="project-status">Status: On GitHub, too old, but the code is (kinda) well documented</span>
              <p class="description">The name comes from our CMPE course. In the course we were given the task of
            ...
            <li><span class="project-name">KaOS</span><span class="project-status">Status: Is being developed on GitHub</span>
              <p class="description">My operating system project. The name comes from my last name (Karaca OS). Also
            ...
            <li><span class="project-name">UI Framework for Cardboard</span><span class="project-status">Status: Discontinued</span>
              <p class="description">This came from the Video Player for Cardboard application Using pure OpenGL was
            ...
            <li><span class="project-name">GyroHand</span><span class="project-status">Status: Currently working on...</span>
              <p class="description">This is my first hardware project. It's basically a glove with gyro sensors on
        ...
        <div class="section">
          <h1>Can I meet u IRL?</h1>
          <p>Maybe? Send me an e-mail, or message, or ... I don't know.
          I go to meetups and developer conferences. Maybe some day, we 
          can meet in one of them.</p>
        </div>
      </div>
    </div>
